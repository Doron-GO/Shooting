...
void InputManager::Init(void)
{
	...
	InputManager::GetInstance().Add(PAD_INPUT_1);
...
void InputManager::Update(void)
{
	...
	GetMousePoint(&mousePos_.intx, &mousePos_.inty);
...
InputManager::JOYPAD_IN_STATE InputManager::GetJPadInputState(JOYPAD_NO no)
{
	...
	case InputManager::JOYPAD_TYPE::XBOX_ONE:
	{
		...
		idx = static_cast<int>(JOYPAD_BTN::R_1);
		ret.ButtonsNew[idx] = d.Buttons[5];// R_1

		idx = static_cast<int>(JOYPAD_BTN::L_1);
		ret.ButtonsNew[idx] = d.Buttons[4]; // L_1
